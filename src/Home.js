...
const social = [
    {
        name: 'Instagram',
        href: 'https://www.instagram.com/delmaass/',
        icon: (props) => (
    ...
    {
        name: 'Twitter',
        href: 'https://twitter.com/LouisDlms',
        icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
    ...
    {
        name: 'LinkedIn',
        href: 'https://www.linkedin.com/in/louis-delmas/',
        icon: (props) => (
            <svg fill="currentColor" style={ {padding: "0 2px 3px 2px"} } viewBox="0 0 24 24" {...props}>
    ...
    {
        name: 'GitHub',
        href: 'https://github.com/delmaass',
        icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
            <path
            fillRule="evenodd"
...
class Home extends React.Component {
    constructor(props) {
        ...
        switch(props.lang) {
            case "FR":
                text = FR.Start.textBackground;
                content = FR;
                break;
            case "EN":
                text = EN.Start.textBackground;
                content = EN;
                break;
            default:
                text = EN.Start.textBackground;
    ...
    render() {
        return (
            <div className="w-vw dark:text-white dark:bg-gray-900 transition-all ">
                ...
                <Biography
                    social={ social }
                    content={ this.state.content.Biography }
                />
                {/* <Timeline /> */}
                <Projects
                    content={ this.state.content.Projects }
                />
                <End
                    social={ social }
